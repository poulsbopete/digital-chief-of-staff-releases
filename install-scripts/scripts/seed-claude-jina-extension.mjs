#!/usr/bin/env node
/**
 * Enable the Jina Claude extension without a Configure dialog.
...
const MANIFEST_REL = join("extensions", "jina", "manifest.json");
    ...
    JSON.stringify(
      {
        ...
        ...manifest,
        ...settings,
        hint: "Quit and reopen Claude Desktop if Jina does not appear under Desktop connectors.",
      },
      null,
      2
    )
